...
const ProfileOpt = () => {
  ...
  return (
    <form
      ...
      className="w-full space-y-2 flex flex-col h-full overflow-y-auto md:overflow-hidden lg:overflow-auto shadow-inner bg-white"
    >
      {/* profile pic */}
      <header className="flex flex-col items-center justify-center w-full group bg-gradient-to-br from-blue-200 via-blue-400 to-pink-400 py-4">
