...
export default function SettingsMenu({ options, activeOptState }) {
  ...
  useEffect(() => {
    setIsOnTop(window.innerWidth <= 768);
  ...
  return (
    <aside className="bg-gray-100 basis-auto md:basis-1/3">
      <ul>
          ...
          {options.map((opt, i) => {
            return (
              <li
                ...
                } cursor-pointer p-2 capitalize duration-200 text-sm md:text-base flex items-center gap-2 h-9`}
              >
