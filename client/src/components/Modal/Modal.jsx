      ...
      <RenderIf conditionIs={modalState.isActive === true}>
        <div
          ...
          className={`fixed z-30 inset-0 flex justify-center items-center animate-fade-in
                    ${modalState.isActive ? "lg:bg-gray-900/40" : ""}
                    `}
        >
          <div
            ref={modal}
            className="h-full lg:h-3/4 lg:max-h-[800px] relative flex flex-col animate-pop-in z-100 lg:rounded-xl overflow-clip bg-gray-100"
          >
